...
main.mostCurrent._text = main.mostCurrent._lblprompt.runMethod(true,"getText");
 BA.debugLineNum = 124;BA.debugLine="Log(\"START: \" & text & CRLF)";
Debug.ShouldStop(134217728);
main.mostCurrent.__c.runVoidMethod ("LogImpl","6393218",RemoteObject.concat(RemoteObject.createImmutable("START: "),main.mostCurrent._text,main.mostCurrent.__c.getField(true,"CRLF")),0);
