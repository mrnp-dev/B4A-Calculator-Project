...
try {
		Debug.PushSubsStack("btnAction_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,171);
if (RapidSub.canDelegate("btnaction_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnaction_click");}
 BA.debugLineNum = 171;BA.debugLine="Private Sub btnAction_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 172;BA.debugLine="btnSender = Sender";
...
main.mostCurrent._btnsender = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.ButtonWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));
 BA.debugLineNum = 173;BA.debugLine="Select btnSender.Tag";
...
case 0: {
 BA.debugLineNum = 175;BA.debugLine="lblPrompt.Text = \"\"";
Debug.ShouldStop(16384);
main.mostCurrent._lblprompt.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 176;BA.debugLine="lblResult.Text = \"\"";
Debug.ShouldStop(32768);
main.mostCurrent._lblresult.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 break; }
case 1: {
 BA.debugLineNum = 179;BA.debugLine="If lblPrompt.Text.Length > 0 Then";
...
if (RemoteObject.solveBoolean(">",main.mostCurrent._lblprompt.runMethod(true,"getText").runMethod(true,"length"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 180;BA.debugLine="lblPrompt.Text = lblPrompt.Text.SubString2(0,";
...
_solve();
 ...
 break; }
case 2: {
 BA.debugLineNum = 184;BA.debugLine="lblPrompt.Text = lblPrompt.Text & btnSender.Tex";
...
main.mostCurrent._lblprompt.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._lblprompt.runMethod(true,"getText"),main.mostCurrent._btnsender.runMethod(true,"getText"))));
 break; }
default: {
 BA.debugLineNum = 186;BA.debugLine="lblPrompt.Text = lblPrompt.Text & btnSender.Tex";
...
;
 BA.debugLineNum = 189;BA.debugLine="If lblPrompt.Text.Length < 10 Then";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("<",main.mostCurrent._lblprompt.runMethod(true,"getText").runMethod(true,"length"),BA.numberCast(double.class, 10))) { 
 BA.debugLineNum = 190;BA.debugLine="lblPrompt.TextSize = 50";
Debug.ShouldStop(536870912);
main.mostCurrent._lblprompt.runMethod(true,"setTextSize",BA.numberCast(float.class, 50));
 }else 
{ BA.debugLineNum = 191;BA.debugLine="Else If lblPrompt.Text.Length < 20 Then";
...
if (RemoteObject.solveBoolean("<",main.mostCurrent._lblprompt.runMethod(true,"getText").runMethod(true,"length"),BA.numberCast(double.class, 20))) { 
 BA.debugLineNum = 192;BA.debugLine="lblPrompt.TextSize = 40";
Debug.ShouldStop(-2147483648);
main.mostCurrent._lblprompt.runMethod(true,"setTextSize",BA.numberCast(float.class, 40));
 }else {
 BA.debugLineNum = 194;BA.debugLine="lblPrompt.TextSize = 30";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("btnOperation_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,142);
if (RapidSub.canDelegate("btnoperation_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnoperation_click");}
 BA.debugLineNum = 142;BA.debugLine="Private Sub btnOperation_Click()";
Debug.ShouldStop(8192);
 BA.debugLineNum = 143;BA.debugLine="btnSender = Sender";
Debug.ShouldStop(16384);
main.mostCurrent._btnsender = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.ButtonWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));
 BA.debugLineNum = 144;BA.debugLine="Select btnSender.Tag";
Debug.ShouldStop(32768);
...
case 0: {
 BA.debugLineNum = 146;BA.debugLine="If lblResult.Text = \"∞\" Then";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean("=",main.mostCurrent._lblresult.runMethod(true,"getText"),BA.ObjectToString("∞"))) { 
 BA.debugLineNum = 147;BA.debugLine="lblPrompt.Text = lblResult.Text";
Debug.ShouldStop(262144);
main.mostCurrent._lblprompt.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._lblresult.runMethod(true,"getText")));
 BA.debugLineNum = 148;BA.debugLine="lblResult.Text = \"\"";
Debug.ShouldStop(524288);
main.mostCurrent._lblresult.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 }else 
{ BA.debugLineNum = 149;BA.debugLine="Else If lblPrompt.Text = \"\" Then";
Debug.ShouldStop(1048576);
...
{ BA.debugLineNum = 151;BA.debugLine="Else If Not(IsNumber(lblResult.Text)) Then";
...
if (main.mostCurrent.__c.runMethod(true,"Not",(Object)(main.mostCurrent.__c.runMethod(true,"IsNumber",(Object)(main.mostCurrent._lblresult.runMethod(true,"getText"))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 152;BA.debugLine="lblResult.Text = \"Expression Error\"";
Debug.ShouldStop(8388608);
main.mostCurrent._lblresult.runMethod(true,"setText",BA.ObjectToCharSequence("Expression Error"));
 }else {
 BA.debugLineNum = 154;BA.debugLine="lblPrompt.Text = lblResult.Text";
Debug.ShouldStop(33554432);
main.mostCurrent._lblprompt.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._lblresult.runMethod(true,"getText")));
 BA.debugLineNum = 155;BA.debugLine="lblResult.Text = \"\"";
Debug.ShouldStop(67108864);
main.mostCurrent._lblresult.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 }}}
;
 break; }
case 1: {
 BA.debugLineNum = 158;BA.debugLine="lblPrompt.Text = lblPrompt.Text & \"x\"";
Debug.ShouldStop(536870912);
main.mostCurrent._lblprompt.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._lblprompt.runMethod(true,"getText"),RemoteObject.createImmutable("x"))));
 break; }
default: {
 BA.debugLineNum = 160;BA.debugLine="lblPrompt.Text = lblPrompt.Text & btnSender.Tex";
Debug.ShouldStop(-2147483648);
main.mostCurrent._lblprompt.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._lblprompt.runMethod(true,"getText"),main.mostCurrent._btnsender.runMethod(true,"getText"))));
 break; }
}
;
 BA.debugLineNum = 162;BA.debugLine="If lblPrompt.Text.Length < 10 Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("<",main.mostCurrent._lblprompt.runMethod(true,"getText").runMethod(true,"length"),BA.numberCast(double.class, 10))) { 
 BA.debugLineNum = 163;BA.debugLine="lblPrompt.TextSize = 50";
Debug.ShouldStop(4);
main.mostCurrent._lblprompt.runMethod(true,"setTextSize",BA.numberCast(float.class, 50));
 }else 
{ BA.debugLineNum = 164;BA.debugLine="Else If lblPrompt.Text.Length < 20 Then";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean("<",main.mostCurrent._lblprompt.runMethod(true,"getText").runMethod(true,"length"),BA.numberCast(double.class, 20))) { 
 BA.debugLineNum = 165;BA.debugLine="lblPrompt.TextSize = 40";
Debug.ShouldStop(16);
main.mostCurrent._lblprompt.runMethod(true,"setTextSize",BA.numberCast(float.class, 40));
 }else {
 BA.debugLineNum = 167;BA.debugLine="lblPrompt.TextSize = 30";
Debug.ShouldStop(64);
main.mostCurrent._lblprompt.runMethod(true,"setTextSize",BA.numberCast(float.class, 30));
 }}
;
...
{ BA.debugLineNum = 91;BA.debugLine="Else If text.CharAt(row) = \"-\" Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",main.mostCurrent._text.runMethod(true,"charAt",(Object)(BA.numberCast(int.class, _row))),BA.ObjectToChar("-"))) { 
 BA.debugLineNum = 92;BA.debugLine="leftCtr = row";
...
;
 BA.debugLineNum = 99;BA.debugLine="If leftCtr = ind Then";
Debug.ShouldStop(4);
...
if (true) return BA.ObjectToString("");
 ...
 BA.debugLineNum = 103;BA.debugLine="Return text.SubString2(leftCtr, ind)";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("GetNumberRight (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,107);
...
int _row = 0;
Debug.locals.put("ind", _ind);
 BA.debugLineNum = 107;BA.debugLine="Private Sub GetNumberRight(ind As Int) As String";
Debug.ShouldStop(1024);
 BA.debugLineNum = 108;BA.debugLine="Dim rightCtr As Int = ind";
Debug.ShouldStop(2048);
_rightctr = _ind;Debug.locals.put("rightCtr", _rightctr);Debug.locals.put("rightCtr", _rightctr);
 BA.debugLineNum = 109;BA.debugLine="For row = ind + 1 To text.Length - 1 Step 1";
Debug.ShouldStop(4096);
{
final int step2 = 1;
...
for (;(step2 > 0 && _row <= limit2) || (step2 < 0 && _row >= limit2) ;_row = ((int)(0 + _row + step2))  ) {
Debug.locals.put("row", _row);
 BA.debugLineNum = 110;BA.debugLine="If text.CharAt(row) = \"-\" And row = ind + 1 Then";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("=",main.mostCurrent._text.runMethod(true,"charAt",(Object)(BA.numberCast(int.class, _row))),BA.ObjectToChar("-")) && RemoteObject.solveBoolean("=",RemoteObject.createImmutable(_row),BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_ind,RemoteObject.createImmutable(1)}, "+",1, 1)))) { 
 BA.debugLineNum = 111;BA.debugLine="rightCtr = row";
Debug.ShouldStop(16384);
_rightctr = BA.numberCast(int.class, _row);Debug.locals.put("rightCtr", _rightctr);
 }else 
{ BA.debugLineNum = 112;BA.debugLine="Else If IsNumber(text.CharAt(row)) Or text.CharA";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean(".",main.mostCurrent.__c.runMethod(true,"IsNumber",(Object)(BA.ObjectToString(main.mostCurrent._text.runMethod(true,"charAt",(Object)(BA.numberCast(int.class, _row))))))) || RemoteObject.solveBoolean("=",main.mostCurrent._text.runMethod(true,"charAt",(Object)(BA.numberCast(int.class, _row))),BA.ObjectToChar("."))) { 
 BA.debugLineNum = 113;BA.debugLine="rightCtr = row";
...
;
 BA.debugLineNum = 119;BA.debugLine="If rightCtr = ind Then";
Debug.ShouldStop(4194304);
...
if (true) return BA.ObjectToString("");
 ...
 BA.debugLineNum = 123;BA.debugLine="Return text.SubString2(ind + 1, rightCtr + 1)";
Debug.ShouldStop(67108864);
...
Debug.ShouldStop(8);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8196609",RemoteObject.createImmutable(" "),0);
 BA.debugLineNum = 37;BA.debugLine="Log(\"Operator : (\" & operator & \") ~~~~~\")";
Debug.ShouldStop(16);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8196610",RemoteObject.concat(RemoteObject.createImmutable("Operator : ("),_operator,RemoteObject.createImmutable(") ~~~~~")),0);
...
Debug.ShouldStop(65536);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8196622",RemoteObject.createImmutable("Invalid"),0);
...
try {
		Debug.PushSubsStack("Solve (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,126);
if (RapidSub.canDelegate("solve")) { return b4a.example.main.remoteMe.runUserSub(false, "main","solve");}
 BA.debugLineNum = 126;BA.debugLine="Private Sub Solve";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 127;BA.debugLine="text = lblPrompt.Text";
Debug.ShouldStop(1073741824);
main.mostCurrent._text = main.mostCurrent._lblprompt.runMethod(true,"getText");
 BA.debugLineNum = 128;BA.debugLine="Log(\"START: \" & text)";
Debug.ShouldStop(-2147483648);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8393218",RemoteObject.concat(RemoteObject.createImmutable("START: "),main.mostCurrent._text),0);
 BA.debugLineNum = 130;BA.debugLine="lblResult.Text = \"\"";
Debug.ShouldStop(2);
main.mostCurrent._lblresult.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 131;BA.debugLine="ProcessOperators(\"÷\")";
Debug.ShouldStop(4);
_processoperators(RemoteObject.createImmutable("÷"));
 BA.debugLineNum = 132;BA.debugLine="ProcessOperators(\"x\")";
Debug.ShouldStop(8);
_processoperators(RemoteObject.createImmutable("x"));
 BA.debugLineNum = 133;BA.debugLine="ProcessOperators(\"%\")";
Debug.ShouldStop(16);
_processoperators(RemoteObject.createImmutable("%"));
 BA.debugLineNum = 134;BA.debugLine="ProcessOperators(\"+\")";
Debug.ShouldStop(32);
_processoperators(RemoteObject.createImmutable("+"));
 BA.debugLineNum = 135;BA.debugLine="ProcessOperators(\"-\")";
Debug.ShouldStop(64);
_processoperators(RemoteObject.createImmutable("-"));
 BA.debugLineNum = 136;BA.debugLine="Log(\" \")";
Debug.ShouldStop(128);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8393226",RemoteObject.createImmutable(" "),0);
 BA.debugLineNum = 137;BA.debugLine="Log(\"RESULT: \" & text)";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8393227",RemoteObject.concat(RemoteObject.createImmutable("RESULT: "),main.mostCurrent._text),0);
 BA.debugLineNum = 138;BA.debugLine="lblResult.Text = text";
Debug.ShouldStop(512);
main.mostCurrent._lblresult.runMethod(true,"setText",BA.ObjectToCharSequence(main.mostCurrent._text));
 BA.debugLineNum = 139;BA.debugLine="Log(\"---------------------------------\")";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8393229",RemoteObject.createImmutable("---------------------------------"),0);
