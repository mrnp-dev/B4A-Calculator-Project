...
public static String  _btnaction_click() throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Private Sub btnAction_Click";
...
case 0: {
 //BA.debugLineNum = 146;BA.debugLine="lblPrompt.Text = \"\"";
...
mostCurrent._lblresult.setText(BA.ObjectToCharSequence(""));
 break; }
case 1: {
 //BA.debugLineNum = 150;BA.debugLine="If lblPrompt.Text.Length > 0 Then";
if (mostCurrent._lblprompt.getText().length()>0) { 
 //BA.debugLineNum = 151;BA.debugLine="lblPrompt.Text = lblPrompt.Text.SubString2(0,";
mostCurrent._lblprompt.setText(BA.ObjectToCharSequence(mostCurrent._lblprompt.getText().substring((int) (0),(int) (mostCurrent._lblprompt.getText().length()-1))));
 //BA.debugLineNum = 152;BA.debugLine="Solve";
_solve();
 };
 break; }
case 2: {
...
mostCurrent._lblprompt.setText(BA.ObjectToCharSequence(mostCurrent._lblprompt.getText()+mostCurrent._btnsender.getText()));
 //BA.debugLineNum = 158;BA.debugLine="Solve";
_solve();
 break; }
}
;
...
mostCurrent._lblresult.setText(BA.ObjectToCharSequence(""));
 break; }
default: {
 //BA.debugLineNum = 138;BA.debugLine="lblPrompt.Text = lblPrompt.Text & btnSender.Tex";
mostCurrent._lblprompt.setText(BA.ObjectToCharSequence(mostCurrent._lblprompt.getText()+mostCurrent._btnsender.getText()));
 break; }
}
;
...
anywheresoftware.b4a.keywords.Common.LogImpl("7196645","Initial text: "+mostCurrent._text,0);
 //BA.debugLineNum = 73;BA.debugLine="text = text.Replace(strRem, NumberFormat2(res, 1";
...
anywheresoftware.b4a.keywords.Common.LogImpl("7196647","Updated text: "+mostCurrent._text,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("7393224","---------------------------------",0);
